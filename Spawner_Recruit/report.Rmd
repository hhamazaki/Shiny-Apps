...
knitr::opts_chunk$set(echo = FALSE,comment=NULL, dev='png',fig.dim = c(9,7),dpi=600,message=FALSE,background=NULL)
...
```{r}
srplot()
cat(paste0("Figure 1.  SR curve (sold line: mean, dash median).  Gray shade indicates ", input$CI,"% Bayesian ",input$Li," interval."))
```
