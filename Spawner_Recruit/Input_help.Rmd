...
Run data type consists of **Calendar Year**, Spawner (Escapement) size, Run size, and run age proportion from the youngest to the lowest.   
...
### Input Data Hacking ###
The input data calculates brood year recruit several ages before the calendar year.  For instance, the above example data creates brood year recruit starting 1963.  When you *DO* have escapement data, then you can hack the table by putting *Real* escapement and *Dummy* run and age data as follows. 
